...
<div class="row">
        <div class="col-md-4 col-md-offset-3">
            <form action="/final/community/community_b.jsp" class="search-form">
...
<br>
    	...
    	communityDBProcess communityDBProcess = new communityDBProcess();
   		...
   		ArrayList<community> list = communityDBProcess.getBestList(search);   		
    				...
    				<div class="thumbnail">
    					...
    					<div class="caption">
	        				<p>	
	        					...
	        					if(likeyuser==null){
	        					%>	
	        						<a href="/final/community/likey_b.jsp?cmNum=<%= list.get(i).getCmNum() %>&cmTitle=<%= list.get(i).getCmTitle() %>"><img src="/final/image/heart_empty.png" id="heart"></a>
	        					<%
	        						}
	        					else{
		        					...
		        					if(user.equals(id)){
		        						%>	
		        						<a href="/final/community/likey_b.jsp?cmNum=<%= list.get(i).getCmNum() %>&cmTitle=<%= list.get(i).getCmTitle() %>"><img src="/final/image/heart.png" id="heart"></a>
		        						<%
		        					}else{
		        						%>	
		        						<a href="/final/community/likey_b.jsp?cmNum=<%= list.get(i).getCmNum() %>&cmTitle=<%= list.get(i).getCmTitle() %>"><img src="/final/image/heart_empty.png" id="heart"></a>
